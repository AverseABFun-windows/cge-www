...
<!-- Include Bootstrap, after jQuery (Bootstrap integrates with jQuery if found) -->
<script src="<?php echo page_requisite('castle-engine-website-base/bootstrap/js/bootstrap.bundle.min.js'); ?>"></script>
